      ...
      `}>
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6 p-8">
                    ...
                    <div className="flex flex-col items-end gap-3">
                        <button className={`
              flex items-center gap-2 text-sm font-medium px-5 py-2.5 rounded-xl border
      ...
      `}>
                {TABS.map((tab, i) => (
                    <button
                        ...
                        onClick={() => setActiveTab(i)}
                        className={`
              px-5 py-2 rounded-xl text-sm font-medium transition-all duration-200 cursor-pointer border-none
              ${activeTab === i
                                ? dark ? "bg-white text-black shadow-lg" : "bg-black text-white shadow-lg"
                                : dark ? "text-zinc-500 hover:text-zinc-300 bg-transparent" : "text-zinc-400 hover:text-zinc-700 bg-transparent"
                            }
            `}
                    >
                        {tab}
