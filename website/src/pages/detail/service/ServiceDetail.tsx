...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    ...
    getOrganization(id)
      .then((response) => {
        if (active) setOrganization(response.data);
      })
      .catch((organizationReason: any) => {
        if (organizationReason?.response?.status !== 404)
          throw organizationReason;
        return getService(id).then((response) => {
        ...
        if (active)
          setError(
            reason?.response?.status === 404
              ? "This professional or service was not found."
              : "Unable to load this professional or service.",
          );
      })
      .finally(() => {
    ...
    : [
        {
          ...
          description:
            "Safe wiring, socket and switch installation for homes & offices.",
          price: "$120",
          duration: "1 hr",
        },
        {
          ...
          description:
            "Expert leak detection, pipe installation, and bathroom renovations.",
          price: "$220",
          duration: "2 hrs",
        },
      ];
            ...
            <ServiceSidebar
              ...
              service={{
                ...
                registration:
                  ...
                  "Licensed Professional in Home Wiring Specialist",
          ...
          <div className="flex flex-col w-full lg:w-[70%] gap-12 pt-0 md:pt-6">
            ...
            <div id="overview" className="flex flex-col gap-12">
                ...
                qualifications={[
                  {
                    ...
                    description:
                      "Body weight training, mobility coaching & survival Scrabble",
                  },
                  {
                    title: "Career highlight",
                    description:
                      "Choreographing a routine for a local fitness commercial",
                  },
                  {
                    title: "Education and training",
                    description: "Apprenticeship, Cert IV in Fitness",
                  },
                ]}
              />
              <div className="w-[70%]">
              ...
              <ServiceLocation
                location={{
                  description:
                    "I travel to you in the area outlined on the map. To book in a different location, you can message me.",
                  mapSrc:
                    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1565451.6961476686!2d143.20816812836224!3d-36.99451188339893!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad646b5d2ba4df7%3A0x4045675218ccd90!2sVictoria%2C%20Australia!5e0!3m2!1sen!2sus!4v1715000000000!5m2!1sen!2sus",
                }}
              />
            </div>
