...
export default function FullListView({
  ...
  const getTitle = () => {
    const typeName = tab || (resultType === "property" ? "properties" : resultType === "comercial" ? "commercial properties" : resultType === "builder" ? (tab === "Agents" ? "buyer agents" : "builders") : "professionals");
