          ...
          {!isAuthenticated ? (
            ...
            <>
              ...
              <button
                ...
                className="block md:hidden w-full text-left px-6 py-3 text-sm font-semibold text-gray-900 hover:bg-gray-50 transition-colors"
              >
                View Profile
              </button>
              <button
                onClick={() => closeAndNav("/profile/personal-info")}
                className="md:block hidden w-full text-left px-6 py-3 text-sm font-semibold text-gray-900 hover:bg-gray-50 transition-colors"
              >
                View Profile
              </button>
